...
public class 재귀함수가뭔가요_이해인 {
    ...
    static void recursion(int depth) {
        ...
        sb.append(indent).append("\"잘 들어보게. 옛날옛날 한 산 꼭대기에 이 세상 모든 지식을 통달한 선인이 있었어.\"\n");
        sb.append(indent).append("\"마을 사람들은 모두 그 선인에게 수많은 질문을 하였고, 모두 지혜롭게 대답해 주었지.\"\n");
